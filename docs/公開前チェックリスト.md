...
git log --all -p \
  | grep -nE "192\.168\.[0-9]{1,3}\.[0-9]{1,3}|10\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}|172\.(1[6-9]|2[0-9]|3[01])\.[0-9]{1,3}\.[0-9]{1,3}|(^|[^[:alnum:]])([[:xdigit:]]{0,4}::[[:xdigit:]:]{0,32}|([[:xdigit:]]{1,4}:){3,7}[[:xdigit:]]{0,4})([^[:alnum:]]|$)|([[:alnum:]-]+\.)+(local|lan|internal)([^[:alnum:]_-]|$)|/(home|Users)/[^/[:space:]\"']+/|/mnt/c/"
